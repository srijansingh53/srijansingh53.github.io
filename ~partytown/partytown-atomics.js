...
(e => {
  const t = () => {},
    ...
    i = e =>
      !(s(e, 'webkit') || s(e, 'toJSON') || s(e, 'constructor') || s(e, 'toString') || s(e, '_')),
    ...
    y = (e, t, r, n, s) => {
      if ((r = m[e]) && r.U) {
        if (e === t) return r.U;
        if (((n = r.U.document), 'd' === (s = t.split('.').pop()))) return n;
        if ('e' === s) return n.documentElement;
        if ('h' === s) return n.head;
        if ('b' === s) return n.body;
      }
      return d.get(t);
    },
    v = (e, t, r) => {
      e &&
        ...
        r > w + 5e3 &&
          (d.forEach((e, t) => {
            e[h] < w && e.nodeType && !e.isConnected && d.delete(t);
          }),
          (w = r)));
    };
  let w = 0;
  const $ = e.parent,
    ...
    C = (e, t, r, i, a) =>
      void 0 !== t && (i = typeof t)
        ? 'string' === i || 'number' === i || 'boolean' === i || null == t
          ? [0, t]
          : 'function' === i
            ? [6]
                    ...
                    : 'Window' === a
                      ...
                      : 'HTMLCollection' === a || 'NodeList' === a
                        ...
                        : a.endsWith('Event')
                          ? [5, I(e, t, r)]
                          : 'CSSRuleList' === a
                            ? [12, Array.from(t).map(M)]
                            : s(a, 'CSS') && a.endsWith('Rule')
                              ? [11, M(t)]
    ...
    I = (e, t, r, s, o, a, l, c) => {
      if (((a = {}), !r.has(t)))
        for (l in (r.add(t), t))
          i(l) &&
            ((c = 'path' === l && n(t).endsWith('Event') ? t.composedPath() : t[l]),
            (s || 'function' != typeof c) && (o || '' !== c) && (a[l] = C(e, c, r)));
      return a;
    },
    M = e => {
      let t,
        r = {};
      for (t in e) P.includes(t) && (r[t] = String(e[t]));
      return r;
    },
    ...
    L = (e, { V: t, w: r, L: n }, s) => (
      (s = p.get(n)) ||
        ((s = function (...s) {
          e.postMessage([9, { V: t, w: r, L: n, R: C(t, this), b: C(t, s) }]);
        }),
        p.set(n, s)),
      s
    ),
    ...
    A = (e, t, r, n) => {
      for (n in ((r = {}), t)) r[n] = x(e, t[n]);
      return r;
    },
    P = 'cssText,selectorText,href,media,namespaceURI,prefix,name,conditionText'.split(','),
    U = async (e, t) => {
      let n,
        s,
        i,
          ...
          ((l = h === u - 1),
            ...
            !m[s] &&
              ...
              (await new Promise(e => {
                let t = 0,
                  r = () => {
                    m[s] || t++ > 1e3 ? e() : requestAnimationFrame(r);
                  };
                r();
              })),
            1 === i[0] && i[1] in m[s].U
              ? v(new m[s].U[i[1]](...x(e, i[2])), n.w)
              : ((o = y(s, n.w)),
                o
                  ? ((a = j(e, s, o, i, l, n.r)),
                    n.d &&
    ...
    j = (e, t, s, i, o, a) => {
      let l,
        ...
        m = r(i);
      for (; p < m; p++) {
        ((c = i[p]), (l = i[p + 1]), (u = i[p - 1]));
        try {
          if (!Array.isArray(l))
            if ('string' == typeof c || 'number' == typeof c) {
              if (p + 1 === m && a) return ((d = {}), a.map(e => (d[e] = s[e])), d);
              s = s[c];
            } else {
              if (0 === l) return void (s[u] = x(e, c));
              if (
                'function' == typeof s[u] &&
                ((h = x(e, c)),
                'define' === u && 'CustomElementRegistry' === n(s) && (h[1] = T(t, e, h[1])),
                'insertRule' === u && h[1] > r(s.cssRules) && (h[1] = r(s.cssRules)),
                (s = s[u].apply(s, h)),
                'play' === u)
              )
    ...
    H = (e, t) => {
      ...
      l && l.body
        ? ((n = l.querySelector(
          ...
          n
            ? ((n.dataset.ptid = s = f(n, o)),
              (i = { V: o, w: s }),
              n.src ? ((i.S = n.src), (i.H = n.dataset.ptsrc || n.src)) : (i.j = n.innerHTML),
              e.postMessage([7, i]))
            : (t.x ||
                ((t.x = 1),
                ((e, t, n) => {
                  ...
                  if (
                    ...
                    for (s = 0; s < r(o); s += 2) l(o[s], o[s + 1]);
                })(e, o, a),
                l.dispatchEvent(new CustomEvent('pt0'))),
              e.postMessage([8, o])))
        : requestAnimationFrame(() => H(e, t));
    },
    O = (e, t, r) => {
      if (!g.has(r)) {
        g.set(r, t);
        ...
        const a = [],
          ...
          c = () => {
            (e.postMessage([5, { V: t, J: i, S: n.baseURI, T: n.visibilityState }]),
              setTimeout(() => {
                ((o = !0),
                  a.forEach(e => {
                    e();
          ...
          u = s.pushState.bind(s),
          h = s.replaceState.bind(s),
          d = (r, s, i, o) => () => {
            setTimeout(() => {
              e.postMessage([
                13,
                { V: t, type: r, state: s, url: n.baseURI, newUrl: i, oldUrl: o },
              ]);
            });
          };
        ((s.pushState = (e, t, r) => {
          (u(e, t, r), l(d(0, e, null == r ? void 0 : r.toString())));
        }),
          (s.replaceState = (e, t, r) => {
            (h(e, t, r), l(d(1, e, null == r ? void 0 : r.toString())));
          }),
          r.addEventListener('popstate', e => {
            l(d(2, e.state));
          }),
          r.addEventListener('hashchange', e => {
            l(d(3, {}, e.newURL, e.oldURL));
          }),
      ...
      e
        ...
        .map(e => {
          const t = e[0],
            r = e[1],
            s = n(t);
          return [s, $[s].prototype, t, r];
        })
        .map(([e, r, n, s]) => D(V, t, e, r, n, s)),
      t
    ),
    F = (e, t, r) => {
      let n = [],
    ...
    D = (e, t, r, s, i, a) => {
      if (!e.has(r)) {
        ...
        const l = Object.getPrototypeOf(s),
          c = n(l),
          u = [],
          h = Object.getOwnPropertyDescriptors(s);
        D(e, t, c, l, i, a);
        for (const e in h) W(u, i, e);
        t.push([r, c, u, a, o(i)]);
      }
    },
    W = (e, t, r, s, o, a) => {
      try {
        i(r) &&
          isNaN(r[0]) &&
          'all' !== r &&
          ('function' == (o = typeof (s = t[r]))
            ? (String(s).includes('[native') || Object.getPrototypeOf(t)[r]) && e.push([r, 5])
            : 'object' === o && null != s
              ? 'Object' !== (a = n(s)) && self[a] && e.push([r, s.nodeType || a])
              : 'symbol' !== o && (r.toUpperCase() === r ? e.push([r, 6, s]) : e.push([r, 6])));
      } catch (e) {
        console.warn(e);
      }
    },
    _ = e => {
      let t,
        ...
        s = 0,
        i = r($[e]);
      for (; s < i; s++) ((t = $[e].key(s)), n.push([t, $[e].getItem(t)]));
      return n;
    },
      ...
      if (0 === i) {
        const e = (() => {
          const e = S.createElement('i'),
            ...
            s = S.createElement('p').attachShadow({ mode: 'open' }),
          ...
          : 11 === i
            ...
            : ((e, t, r) => {
                4 === t[0]
                  ...
                  : (r = m[t[1]]) &&
                    (7 === t[0]
                      ? requestAnimationFrame(() => H(e, r))
                      : 6 === t[0] &&
                        ((e, t, r, n, s) => {
                          ((s = t.U.document.querySelector(`[data-ptid="${r}"]`)) &&
                            (n ? (s.dataset.pterror = n) : (s.type += '-x'), delete s.dataset.ptid),
                            H(e, t));
                        })(e, r, t[2], t[3]));
              })(n, s);
    };
  })((e, t) => U(q, e).then(t)).then(e => {
    e &&
      ((q = new Worker(
        URL.createObjectURL(
          new Blob(
      ...
      (q.onmessage = t => {
        const r = t.data;
        12 === r[0] ? U(q, r[1]) : e(q, r);
      }),
      $.addEventListener('pt1', e => O(q, f(e.detail.frameElement), e.detail)));
  });
})(window);
