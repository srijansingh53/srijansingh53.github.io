/*! For license information please see c28bee9a10d659986912257e3b3fa4bf3bb104b0-34637f4d9aae59035f2c.js.LICENSE.txt */
  ...
  [30],
  {
      ...
      function a(e, i) {
        ...
        if (e && i && 'object' == typeof e && 'object' == typeof i) {
          ...
          if (Array.isArray(e)) {
            ...
            for (l = o; 0 !== l--; ) if (!a(e[l], i[l])) return !1;
            return !0;
          }
          ...
          if (r && ArrayBuffer.isView(e) && ArrayBuffer.isView(i)) {
            if ((o = e.length) != i.length) return !1;
            for (l = o; 0 !== l--; ) if (e[l] !== i[l]) return !1;
            return !0;
          }
          ...
          for (l = o; 0 !== l--; ) if (!Object.prototype.hasOwnProperty.call(i, s[l])) return !1;
          if (t && e instanceof Element) return !1;
          for (l = o; 0 !== l--; )
            if (
              (('_owner' !== s[l] && '__v' !== s[l] && '__o' !== s[l]) || !e.$$typeof) &&
              !a(e[s[l]], i[s[l]])
            )
              return !1;
          return !0;
                      ...
                      var g,
                        ...
                        B = p
                          ...
                          : (function (t, u, n, a) {
                              ...
                              w,
                              parseInt(
                                'function' == typeof d.offset ? d.offset(n, l) : d.offset,
                                10,
                              ),
                              d.clip,
                            ),
    ...
    2532: function (e, t, u) {
      ...
      function d(e, t, u) {
        ...
        return (
          s() || ((n.position = 'relative'), (n.overflow = 'hidden')),
          'fixed' === u
            ? ((n.width = e), (n.height = t))
            : 'constrained' === u &&
              (s() || ((n.display = 'inline-block'), (n.verticalAlign = 'top')),
      ...
      const m = ['children'],
        ...
        C = function (e) {
          let { src: t, srcSet: u, loading: r, alt: a = '', shouldLoad: l } = e,
            s = o(e, h);
        ...
        A = function (e) {
          ...
          const l = a.sizes || (null == t ? void 0 : t.sizes),
            s = n.createElement(C, i({}, a, t, { sizes: l, shouldLoad: r }));
          return u.length
            ? n.createElement(
                'picture',
                null,
      ...
      const M = function (e) {
        ...
        N = (0, n.memo)(function (e) {
          return e.image ? (s(), (0, n.createElement)(M, e)) : null;
        });
      ((N.propTypes = S), (N.displayName = 'GatsbyImage'));
      const j = [
        'src',
        '__imageData',
        '__error',
      ...
      function P(e) {
        return function (t) {
          ...
          return (
            a && console.warn(a),
            r ? n.createElement(e, i({ image: r }, l)) : (console.warn('Image not loaded', u), null)
          );
        };
      }
      const R = P(function (e) {
          ...
          const {
            ...
            I = o(L, w),
            M = { fallback: void 0, sources: [] };
          return (
            k.fallback &&
              (M.fallback = i({}, k.fallback, {
                srcSet: k.fallback.srcSet ? B(k.fallback.srcSet) : void 0,
              })),
            k.sources && (M.sources = k.sources.map(e => i({}, e, { srcSet: B(e.srcSet) }))),
            n.createElement(
              t,
              i({}, I, {
          ...
          return (
            ...
            (u.render = function () {
              var e = this.props,
                ...
                l = d(this.state.children).map(u);
              return (
                delete r.appear,
                delete r.enter,
                delete r.exit,
                null === t
                  ? i.createElement(o.A.Provider, { value: a }, l)
                  : i.createElement(o.A.Provider, { value: a }, i.createElement(t, r, l))
              );
            }),
            t
          );
    ...
    4488: function (e, t, u) {
      ...
      var n = u(7680),
        ...
        a = function (e, t) {
          ...
          if (u < 8)
            for (var i, o, l = 1; l < u; ) {
              for (o = l, i = e[l]; o && t(e[o - 1], i) > 0; ) e[o] = e[--o];
              o !== l++ && (e[o] = i);
            }
          else
            for (
      ...
      const t =
        ...
        s = (e, r) => {
          ...
          const a = !1 === r.locale ? e => e.toLowerCase() : e => e.toLocaleLowerCase(r.locale),
            s = !1 === r.locale ? e => e.toUpperCase() : e => e.toLocaleUpperCase(r.locale);
          if (1 === e.length) return r.pascalCase ? s(e) : a(e);
          return (
            e !== a(e) &&
              (e = ((e, n, r) => {
                let a = !1,
                ...
                for (let l = 0; l < e.length; l++) {
                  const s = e[l];
                  a && t.test(s)
                    ? ((e = e.slice(0, l) + '-' + e.slice(l)), (a = !1), (o = i), (i = !0), l++)
                    : i && o && u.test(s)
                      ? ((e = e.slice(0, l - 1) + '-' + e.slice(l - 1)),
                        (o = i),
                        (i = !1),
                        (a = !0))
                      : ((a = n(s) === s && r(s) !== s), (o = i), (i = r(s) === s && n(s) !== s));
                }
                return e;
              })(e, a, s)),
            (e = e.replace(i, '')),
            (e = r.preserveConsecutiveUppercase
              ...
              : a(e)),
            r.pascalCase && (e = s(e.charAt(0)) + e.slice(1)),
            ((e, t) => (
              (o.lastIndex = 0),
              (l.lastIndex = 0),
              e.replace(o, (e, u) => t(u)).replace(l, e => t(e))
            ))(e, s)
          );
        };
          ...
          return (
              ...
              if ((void 0 === e && (e = !1), null !== t))
                if ((this.cancelNextCallback(), t === m)) {
                  if (this.props.unmountOnExit || this.props.mountOnEnter) {
                    var u = this.props.nodeRef ? this.props.nodeRef.current : l.findDOMNode(this);
                    u && d(u);
                  }
                  this.performEnter(e);
            ...
            (u.performEnter = function (e) {
              var t = this,
                ...
                r = this.props.nodeRef ? [n] : [l.findDOMNode(this), n],
                a = r[0],
                i = r[1],
                o = this.getTimeouts(),
    ...
    7383: function (e, t, u) {
      ...
      function l(e, t) {
        for (var u = i(e), n = i(t), r = [], a = 0; a < 4; a++)
          for (var o = [u[a], u[a + 4], u[a + 8], u[a + 12]], l = 0; l < 4; l++) {
            var s = 4 * l,
              c = [n[s], n[s + 1], n[s + 2], n[s + 3]],
      ...
      function F(e) {
        ...
        if (h.length) {
          ((y.property = v('transform')),
            (y.computed = { raw: t[y.property], matrix: s(t[y.property]) }),
      ...
      function R(e, t, u) {
        ...
        try {
          ...
          var s = l.reduce(function (e, u) {
            var o = {},
              l = u.getAttribute('data-sr-id');
            l
              ? (w(o, n.store.elements[l]), y(o.node, o.styles.inline.computed))
              : ((o.id = S()), (o.node = u), (o.seen = !1), (o.revealed = !1), (o.visible = !1));
            var s = w({}, o.config || n.defaults, t);
            if ((!s.mobile && B()) || (!s.desktop && !B())) return (l && b.call(n, o), e);
            var c,
              d = a(s.container)[0];
      ...
      function W(e) {
        ...
        if (t) {
          var u = Math.max(0, Math.min(1, e.config.viewFactor)),
            ...
            s = t.geometry.bounds.right + t.scroll.left - n.right,
            c = t.geometry.bounds.bottom + t.scroll.top - n.bottom,
            d = t.geometry.bounds.left + t.scroll.left + n.left;
          return (r < c && a > d && i > l && o < s) || 'fixed' === e.styles.position;
        }
      }
      function Y(e, t) {
        var u = this;
        (void 0 === e && (e = { type: 'init' }),
          ...
          m(function () {
            ...
            (g(u.store.containers, function (e) {
              ...
              g(t, function (e) {
                e.sequence ? M.call(u, e) : L.call(u, e);
              }),
              (u.pristine = !1));
          }));
      }
    ...
    7786: function (e, t, u) {
      ...
      const o = e => {
        ...
        const { pathname: l } = (0, a.useLocation)(),
          { site: s } = (0, i.useStaticQuery)('1994492073'),
          {
            defaultTitle: c,
          ...
          p = { title: t || c, description: u || d, image: '' + D + (o || f), url: '' + D + l };
        return n.createElement(
          r.m,
      ...
      var d = {
        ...
        mixins: {
          flexCenter: (0, s.css)(['display:flex;justify-content:center;align-items:center;']),
          flexBetween: (0, s.css)([
      ...
      const x = s.default.a.withConfig({
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  a && r
                    ? n.createElement(Me, { finishLoading: () => i(!1) })
                    : n.createElement(
                        w,
                        null,
      ...
      function j(e, t) {
        var u = N(e),
          n = O(M.und(u[0]) ? 1 : u[0], 0.1, 100),
          r = O(M.und(u[1]) ? 100 : u[1], 0.1, 100),
          a = O(M.und(u[2]) ? 10 : u[2], 0.1, 100),
          i = O(M.und(u[3]) ? 0 : u[3], 0.1, 100),
          o = Math.sqrt(r / n),
          l = a / (2 * Math.sqrt(r * n)),
          s = l < 1 ? o * Math.sqrt(1 - l * l) : 0,
          c = l < 1 ? (l * o - i) / s : -i + o;
        function d(e) {
          var u = t ? (t * e) / 1e3 : e;
          return (
            (u =
              l < 1
                ? Math.exp(-u * l * o) * (1 * Math.cos(s * u) + c * Math.sin(s * u))
                : (1 + c * u) * Math.exp(-u * o)),
            0 === e || 1 === e ? e : 1 - u
          );
        }
        ...
        H = (function () {
          ...
          return function (t, u, n, i) {
            if (0 <= t && t <= 1 && 0 <= n && n <= 1) {
              ...
              if (t !== u || n !== i) for (var l = 0; l < 11; ++l) o[l] = r(l * e, t, n);
              return function (e) {
                return (t === u && n === i) || 0 === e || 1 === e ? e : r(s(e), u, i);
              };
            }
            function s(u) {
              for (var i = 0, l = 1; 10 !== l && o[l] <= u; ++l) i += e;
              --l;
              var s = i + ((u - o[l]) / (o[l + 1] - o[l])) * e,
                c = a(s, t, n);
              return c >= 0.001
                ? (function (e, t, u, n) {
                    for (var i = 0; i < 4; ++i) {
      ...
      function Z(e, t) {
        var u = $(e);
        for (var n in t) u[n] = M.und(e[n]) ? t[n] : e[n];
        return u;
      }
      function J(e) {
        return M.rgb(e)
              ...
              ? (function (e) {
                  ...
                  if (0 == i) t = u = n = o;
                    ...
                    var c = o < 0.5 ? o * (1 + i) : o + i - o * i,
                      d = 2 * o - c;
                    ((t = s(d, c, a + 1 / 3)), (u = s(d, c, a)), (n = s(d, c, a - 1 / 3)));
                  }
                  return 'rgba(' + 255 * t + ',' + 255 * u + ',' + 255 * n + ',' + l + ')';
                })(e)
              : void 0;
        var t, u;
      }
      ...
      function re(e, t) {
        return M.dom(e) && !M.inp(e) && (!M.nil(te(e, t)) || (M.svg(e) && e[t]))
          ? 'attribute'
          : M.dom(e) && Q(T, t)
            ? 'transform'
            : M.dom(e) && 'transform' !== t && ne(e, t)
              ? 'css'
              : null != e[t]
                ? 'object'
                : void 0;
      ...
      function fe(e, t) {
        var u = t || {},
          n =
            u.el ||
            (function (e) {
              for (var t = e.parentNode; M.svg(t) && M.svg(t.parentNode); ) t = t.parentNode;
              return t;
            })(e),
          ...
          i = r.width,
          o = r.height,
          l = u.viewBox || (a ? a.split(' ') : [0, 0, i, o]);
        return { el: n, viewBox: l, x: l[0] / 1, y: l[1] / 1, w: i, h: o, vW: l[2], vH: l[3] };
      }
      function me(e, t, u) {
        function n(u) {
          void 0 === u && (u = 0);
      ...
      function pe(e, t) {
        var u = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
          n = se(M.pth(e) ? e.totalLength : e, t) + '';
        return {
          original: n,
          numbers: n.match(u) ? n.match(u).map(Number) : [0],
          strings: M.str(e) || t ? n.split(u) : [],
        };
      }
      function Ee(e) {
        return Y(e ? U(M.arr(e) ? e.map(G) : G(e)) : [], function (e, t, u) {
      ...
      function ge(e, t) {
        var u = $(t);
        if ((/^spring/.test(u.easing) && (u.duration = j(u.easing)), M.arr(e))) {
          var n = e.length;
          2 === n && !M.obj(e[0])
            ? (e = { value: e })
            : M.fnc(t.duration) || (u.duration = t.duration / n);
        }
        var r = M.arr(e) ? e : [e];
        return r
          .map(function (e, u) {
            var n = M.obj(e) && !M.pth(e) ? e : { value: e };
            return (
              M.und(n.delay) && (n.delay = u ? 0 : t.delay),
              M.und(n.endDelay) && (n.endDelay = u === r.length - 1 ? t.endDelay : 0),
              n
            );
          })
          .map(function (e) {
      ...
      function Ce(e, t) {
                ...
                var t = Y(
                  ...
                  n = function (n) {
                    ...
                    u[r] = e.map(function (e) {
                      var t = {};
                      for (var u in e) M.key(u) ? u == r && (t.value = e[u]) : (t[u] = e[u]);
                      return t;
                    });
                  },
                  r = 0;
        ...
        t))
          M.key(r) && u.push({ name: r, tweens: ge(t[r], e) });
        return u;
      }
      function Ae(e, t) {
        var u;
        return e.tweens.map(function (n) {
          ...
          return (
            ...
            (r.isPath = M.pth(a)),
            (r.isPathTargetInsideSVG = r.isPath && M.svg(t.target)),
            (r.isColor = M.col(r.from.original)),
            r.isColor && (r.round = 1),
            (u = r),
            r
          );
      ...
      function Se(e) {
        ...
        function d() {
          ((u = 0), (n = c(l.currentTime) * (1 / Se.speed)));
        }
        function D(e, t) {
          t && t.seek(e - t.timelineOffset);
        }
        function f(e) {
          for (var t = 0, u = l.animations, n = u.length; t < n; ) {
            var r = u[t],
              a = r.animatable,
              i = r.tweens,
              o = i.length - 1,
            ...
            for (
              var c = O(e - s.start - s.delay, 0, s.duration) / s.duration,
                d = isNaN(c) ? 1 : s.easing(c),
                D = s.to.strings,
                f = s.round,
                m = [],
                p = s.to.numbers.length,
                E = void 0,
                h = 0;
              h < p;
              h++
              ...
              var g = void 0,
                C = s.to.numbers[h],
                A = s.from.numbers[h] || 0;
              ((g = s.isPath ? me(s.value, d * C, s.isPathTargetInsideSVG) : A + d * (C - A)),
                f && ((s.isColor && h > 2) || (g = Math.round(g * f) / f)),
                m.push(g));
            }
            var v = D.length;
            if (v) {
        ...
        function p(e) {
          var d = l.duration,
            ...
            E = d - l.endDelay,
            h = c(e);
          ((l.progress = O((h / d) * 100, 0, 100)),
            (l.reversePlayback = h < l.currentTime),
            t &&
              (function (e) {
                if (l.reversePlayback) for (var u = a; u--; ) D(e, t[u]);
            ...
            h <= p && 0 !== l.currentTime && f(0),
            ((h >= E && l.currentTime !== d) || !d) && f(d),
            h > p && h < E
              ? (l.changeBegan ||
              ...
              l.remaining
                ...
                : ((l.paused = !0),
                  l.completed ||
                    ...
                    m('loopComplete'),
                    m('complete'),
                    !l.passThrough && 'Promise' in window && (i(), o(l))))));
        }
        return (
          (l.reset = function () {
            var e = l.direction;
            ((l.passThrough = !1),
              ...
              (l.remaining = l.loop),
              (t = l.children));
            for (var u = (a = t.length); u--; ) l.children[u].reset();
          ...
          (l.play = function () {
            l.paused && (l.completed && l.reset(), (l.paused = !1), we.push(l), d(), Be());
          }),
          (l.reverse = function () {
      ...
      ((Se.version = '3.2.1'),
        ...
        (Se.stagger = function (e, t) {
          ...
          return function (e, t, h) {
            if ((o && (i = 0), l && (i = (h - 1) / 2), s && (i = h - 1), !p.length)) {
              for (var g = 0; g < h; g++) {
                if (r) {
                  var C = l ? (r[0] - 1) / 2 : i % r[0],
                    A = l ? (r[1] - 1) / 2 : Math.floor(i / r[0]),
                    v = C - (g % r[0]),
          ...
          return (
            ...
            (t.add = function (u, n) {
              ...
              ((l.autoplay = !1),
                ...
                (l.timelineOffset = M.und(n) ? s : le(n, s)),
                i(t),
      ...
      var Oe = Se,
        ze = u(3270);
      const Ie = s.default.div.withConfig({
      ...
      var He = function (e) {
        ...
        return (
          (0, n.useEffect)(() => {
            ...
            return (
              r ? i(t) : window.addEventListener('scroll', l),
      ...
      const qe = s.default.header.withConfig({
      ...
      var Ke = () => {
        ...
        (0, n.useEffect)(
          () => (
            ...
            (o = [u.current].concat((0, Ue.A)(Array.from(a.current.querySelectorAll('a'))))),
            (l = o[0]),
            (s = o[o.length - 1]),
            () => {
      ...
      const Ze = s.default.div.withConfig({
      ...
      const Xe = s.default.ul.withConfig({
      ...
      const tt = s.default.div.withConfig({
      ...
      const nt = s.default.footer.withConfig({
      ...
      const it = s.default.section.withConfig({
      ...
      var ot = () => {
          ...
          const u = [
            ...
            n.createElement('h3', { className: 'big-heading' }, 'I build the Artificial Eye.'),
            n.createElement(
              'p',
              null,
        ...
        lt = u(2532),
        st = u(7383);
      const ct = s.default.section.withConfig({
      ...
      var ft = () => {
        const e = (0, i.useStaticQuery)('2772598474'),
          t = (0, n.useRef)(null);
        (0, n.useEffect)(() => {
          st.A.reveal(t.current, (0, Pe.srConfig)());
        }, []);
        const u = [
          'Pytorch | Keras',
          'ML/DL',
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                'div',
                null,
                n.createElement('p', null, 'Hello! I am an ML engineer based in Kolkata, India.'),
                n.createElement(
                  'p',
                  null,
                  'I enjoy building things that solves complex problem involving any data using the latest technologies. I always strive to deliver perfect solutions with the data in hand and hence empowering the tech itself.',
                ),
                n.createElement(
                  'p',
                  null,
                  ...
                  n.createElement(
                    'a',
                    { href: 'https://www.iiitdmj.ac.in', target: '_blank', rel: 'noreferrer' },
                    'IIIT Jabalpur',
                  ),
                  ', which is completing on May 2021. I have done previous intenships at 3 different companies where I worked on a wide variety of interesting and meaningful projects.',
                ),
            ...
            n.createElement(
              ...
              n.createElement(
                'div',
                { className: 'wrapper' },
                n.createElement(lt.G, {
                  image: (0, lt.c)(e.avatar),
                  alt: 'Avatar',
                  className: 'img',
                }),
              ),
      ...
      const mt = s.default.section.withConfig({
      ...
      var Ct = () => {
        const e = (0, i.useStaticQuery)('1075814354').jobs.edges,
          ...
          o = (0, n.useRef)([]),
          l = (0, n.useRef)(null);
        (0, n.useEffect)(() => st.A.reveal(l.current, (0, Pe.srConfig)()), []);
        (0, n.useEffect)(() => {
          o.current[r]
            ? o.current[r].focus()
            ...
            e &&
              e.map((e, u) => {
                ...
                const { frontmatter: a, html: i } = r,
                  { title: o, url: l, company: s, range: c } = a;
                return n.createElement(
                  je.A,
      ...
      const At = s.default.div.withConfig({
      ...
      var vt = () => {
        ...
        return (
          (0, n.useEffect)(() => {
            (st.A.reveal(t.current, (0, Pe.srConfig)()),
              u.current.forEach((e, t) => st.A.reveal(e, (0, Pe.srConfig)(100 * t))));
          }, []),
          n.createElement(
            'section',
            { id: 'projects' },
            ...
            n.createElement(
              ...
              e &&
                e.map((e, t) => {
                  let { node: r } = e;
                  const { frontmatter: a, html: i } = r,
                    { external: o, title: l, tech: s, github: c, cover: d } = a;
                  return n.createElement(
                    At,
                    ...
                    n.createElement(
                      ...
                      s.length &&
                        n.createElement(
                          ...
                          s.map((e, t) => n.createElement('li', { key: t }, e)),
                        ),
                      n.createElement(
                        'div',
                    ...
                    n.createElement(
                      ...
                      n.createElement(
                        ...
                        n.createElement(lt.G, { image: (0, lt.c)(d), alt: l, className: 'img' }),
                      ),
                    ),
                  );
                }),
      ...
      const Ft = s.default.section.withConfig({
      ...
      var bt = () => {
        const e = (0, i.useStaticQuery)('3519264843'),
          { 0: t, 1: u } = (0, n.useState)(!1),
          r = (0, n.useRef)(null),
          a = (0, n.useRef)(null),
          o = (0, n.useRef)([]);
        (0, n.useEffect)(() => {
          (st.A.reveal(r.current, (0, Pe.srConfig)()),
            st.A.reveal(a.current, (0, Pe.srConfig)()),
            o.current.forEach((e, t) => st.A.reveal(e, (0, Pe.srConfig)(100 * t))));
        }, []);
            ...
            c &&
              c.map((e, t) => {
                ...
                const { frontmatter: r, html: a } = u,
                  { github: i, external: l, title: s, tech: c } = r;
                return n.createElement(
                  je.A,
      ...
      const xt = s.default.section.withConfig({
      ...
      var wt = () => {
        ...
        return (
          (0, n.useEffect)(() => st.A.reveal(e.current, (0, Pe.srConfig)()), []),
          n.createElement(
            xt,
            { id: 'contact', ref: e },
      ...
      var n,
          ...
          return u
            ...
            .reduce(function (e, u) {
              ...
              u.filter(function (e) {
                ...
                return (n[u] || (n[u] = {}), r[u] || (r[u] = {}), !n[u][s] && ((r[u][s] = !0), !0));
              })
                .reverse()
                .forEach(function (t) {
                  return e.push(t);
        ...
        ie = function (e, t) {
          ...
          if (u) {
            for (
              ...
              var l = i[o],
                s = t[l] || '';
              (u.getAttribute(l) !== s && u.setAttribute(l, s), -1 === r.indexOf(l) && r.push(l));
              var c = a.indexOf(l);
              -1 !== c && a.splice(c, 1);
            }
        ...
        de = function (e) {
          ...
          return {
            ...
            script: ce(C.SCRIPT, l, n),
            style: ce(C.STYLE, s, n),
...
//# sourceMappingURL=c28bee9a10d659986912257e3b3fa4bf3bb104b0-34637f4d9aae59035f2c.js.map
