  ...
  (this.workbox.routing = (function (t, e, r) {
    ...
    class c {
      ...
      handleRequest({ request: t, event: e }) {
        ...
        let s,
          { params: n, route: o } = this.findMatchingRoute({ url: r, request: t, event: e }),
          i = o && o.handler;
        if ((!i && this.u && (i = this.u), i)) {
          ...
          return (
            s && this.h && (s = s.catch(t => this.h.handle({ url: r, event: e, err: t }))),
            s
          );
        }
      }
          ...
          if (o)
            return (
              Array.isArray(o) && o.length > 0
                ? (s = o)
                : o.constructor === Object && Object.keys(o).length > 0 && (s = o),
              { route: n, params: s }
            );
        }
        return {};
      ...
      unregisterRoute(t) {
        if (!this.i.has(t.method))
          throw new r.WorkboxError('unregister-route-but-not-found-with-method', {
            method: t.method,
          });
