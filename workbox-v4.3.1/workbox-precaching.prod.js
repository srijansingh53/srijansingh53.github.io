((this.workbox = this.workbox || {}),
  (this.workbox.precaching = (function (t, e, n, s, c) {
    ...
    function r(t) {
      if (!t) throw new c.WorkboxError('add-to-cache-list-unexpected-type', { entry: t });
      if ('string' == typeof t) {
        const e = new URL(t, location);
        return { cacheKey: e.href, url: e.href };
      }
      const { revision: e, url: n } = t;
      if (!n) throw new c.WorkboxError('add-to-cache-list-unexpected-type', { entry: t });
      if (!e) {
    ...
    class l {
      ...
      async o({ url: t, event: e, plugins: o }) {
        ...
        if (!(a ? a({ event: e, request: i, response: r }) : r.status < 400))
          throw new c.WorkboxError('bad-precaching-response', { url: t, status: r.status });
        (r.redirected &&
    ...
    const f = t => {
      ...
      L = t => {
        (h().addToCacheList(t),
          t.length > 0 && (addEventListener('install', y), addEventListener('activate', p)));
      };
    return (
      (t.addPlugins = t => {
        i.add(t);
          ...
          t.waitUntil(
            (async (t, e = '-precache-') => {
              const n = (await caches.keys()).filter(
                n => n.includes(e) && n.includes(self.registration.scope) && n !== t,
              );
