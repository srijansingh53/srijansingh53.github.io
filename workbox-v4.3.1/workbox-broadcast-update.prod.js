((this.workbox = this.workbox || {}),
  (this.workbox.broadcastUpdate = (function (e, t) {
    ...
    class c {
      constructor({ headersToCheck: e, channelName: t, deferNoticationTimeout: s } = {}) {
        ((this.t = e || i), (this.s = t || n), (this.i = s || a), this.o());
      }
      notifyIfUpdated({ oldResponse: e, newResponse: t, url: n, cacheName: a, event: i }) {
        if (!s(e, t, this.t)) {
          const e = (async () => {
            (i && i.request && 'navigate' === i.request.mode && (await this.h(i)),
      ...
      u() {
        return (
          'BroadcastChannel' in self && !this.p && (this.p = new BroadcastChannel(this.s)),
          this.p
        );
      }
      h(e) {
    ...
    return (
      ...
      (e.Plugin = class {
        ...
        cacheDidUpdate({ cacheName: e, oldResponse: t, newResponse: s, request: n, event: a }) {
          t &&
