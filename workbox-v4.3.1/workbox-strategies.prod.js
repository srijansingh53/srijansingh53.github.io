  ...
  (this.workbox.strategies = (function (e, t, s, n, r) {
    ...
    class i {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        if (!i) throw new r.WorkboxError('no-response', { url: t.url, error: n });
        return i;
      }
      async u(e, t) {
    ...
    const u = {
      cacheWillUpdate: ({ response: e }) => (200 === e.status || 0 === e.status ? e : null),
    };
    class a {
      constructor(e = {}) {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        let i;
        if (this.o) {
          const { id: r, promise: h } = this.l({ request: t, event: e, logs: s });
          ((i = r), n.push(h));
        }
        const h = this.q({ timeoutId: i, request: t, event: e, logs: s });
        n.push(h);
        let u = await Promise.race(n);
        if ((u || (u = await h), !u)) throw new r.WorkboxError('no-response', { url: t.url });
        return u;
      }
      ...
      async q({ timeoutId: e, request: t, logs: r, event: i }) {
        ...
        if ((e && clearTimeout(e), h || !u)) u = await this.p({ request: t, event: i });
        else {
          const e = u.clone(),
    ...
    class c {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        if (!i) throw new r.WorkboxError('no-response', { url: t.url, error: s });
        return i;
      }
    }
    class o {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        if (!h) throw new r.WorkboxError('no-response', { url: t.url, error: i });
        return h;
      }
